...
#include <L298NX2.h> // Using "L298N" library found through arduino library manager developed by Andrea Lombardo (https://urldefense.com/v3/__https://github.com/AndreaLombardo/L298N__;!!Mih3wA!A935mnUyvIwIAqWVablX0URe9uj1PqRTqC3FlC2C33hEnzY8UA0johN1fyMJxuP2e1fzzi2-PKOBnsU$ )
#include <FastLED.h>
// ************************************************************************************************* //
// ************************************************************************************************* //
...
void setup() {
 ...
 FastLED.addLeds<WS2811, LED_PIN, GRB>(leds, NUM_LEDS).setCorrection(TypicalLEDStrip);
  FastLED.setBrightness(100);
    pinMode(LED_PIN, OUTPUT);                // Initialize all LEDs to output
  turnAllLedsOn(CRGB::White);
...
void RunMotors() {
  ...
  runMotorAtSpeed(LEFT, -1 * M2SpeedtoMotor); // run right motor 
  runMotorAtSpeed(RIGHT, -1 * M1SpeedtoMotor); // run left motor
} // end RunMotors()
